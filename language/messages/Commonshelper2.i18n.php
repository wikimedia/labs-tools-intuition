...
{{Identical|Upload}}',
	'standard_project' => '{{Optional}}
The biggest project (e.g. "wikipedia") in this language. Used for standard values in maindesk and metadata-links.
{{Identical|Wikipedia}}',
	'error_tusc_failed' => '
{{hint-TUSC}}',
...
$messages['fa'] = array(
	...
	'help_mail' => 'ارسال رایانامه به $1',
	'help_commons' => '$1یک پست در ویکی‌انبار اضافه کرد$2',
);
...
$messages['lrc'] = array(
	...
	'categories' => 'دسه يا',
	'remove_cats' => 'دسه یا که هئیشو وردارینشو',
	...
	'original_wikitext' => 'نیسه اصلی ویکی',
	'new_wikitext' => 'نیسه تازه ویکی',
	'new_filename' => 'نوم فایل تازه:',
...
$messages['mk'] = array(
	...
	'description' => 'Алатка за пренос на податотеки од проектите на Викимедија во Ризницата',
...
$messages['mr'] = array(
	...
	'change_meta' => '$3 साठी $1 वर्ग व $2 साचा मांडणी बदला',
	'jira_link' => 'गणकदोष नोंदवा किंवा प्रारुप सुचवा',
	'language' => 'भाषा',
	'project' => 'प्रकल्प',
	'source_file' => 'स्रोत संचिका',
	'target_file' => 'लक्ष्य संचिका',
	'commons_username' => 'विकिमीडिया कॉमन्स सदस्यनाम',
	'commons_to_project' => 'विकिमीडिया कॉमन्स ते प्रकल्प',
	'move_file_from_com' => 'संचिकेचे स्थानांतरण विकिमीडिया कॉमन्स ते प्रकल्प असे करा',
	'categories' => 'वर्ग',
	'remove_cats' => 'सध्या असलेले वर्ग हटवा',
	'use_checkusage' => 'नविन वर्ग सुचविण्यास $1सामान्यज्ञान$2 वापरा',
	'use_tusc' => 'ती संचिका अधिप्रमाणन व थेट बदली करण्यास $1TUSC$2 चा वापर करा',
	'tusc_user' => 'TUSC सदस्यनाव',
	'tusc_pass' => 'TUSC परवलीचा शब्द (पासवर्ड)',
	'do_it' => 'करा',
	...
	'error_diff_exists' => 'अशाच नावाची वेगळी लक्ष्य संचिका लक्ष्य विकिवर पूर्वीच उपलब्ध आहे!',
	'error_no_meta' => 'स्रोतविकिबद्दल काहीच मेटाडाटा मिळाला नाही! $1कृपया प्रकल्प $2 साठी मेटाडाटा जोडा किंवा अद्यतन करा',
	'error_meta_bad' => 'Metadata:खराब साचे सापडलेत! $1कृपया प्रकल्प $2 साठी मेटाडाटा जोडा किंवा अद्यतन करा',
	'original_wikitext' => 'मुळ विकि मजकूर',
	'new_wikitext' => 'नविन विकि मजकूर',
	'new_filename' => 'नविन संचिकानाम',
	'output_information' => 'मानवीकृत अपभारणासाठी,उपरोक्त मजकूर संपादा(आवश्यक असल्यास)आपल्या संगणकावर संचिका$2 जतन करा$1 मग $3 अपभारण करा$4.',
	'upload_submit' => 'अपभारीत करा!',
	'target_wiki' => 'लक्ष्य विकि',
	'error_bot_blocked' => 'विकिमीडिया कॉमन्सवर अपभारण सांगकाम्या प्रतिबंधित आहे.',
	'error_upload_meta' => 'थेट अपभारण करू शकत नाही कारण मेटा डाटा बद्दल अडचण आहे (वर बघा)!',
	'error_tusc_failed' => 'TUSC पडताळणी अयशस्वी',
	'error_only_commons' => 'थेट अपभारण(अपलोड) फक्त विकिमिडिया कॉमन्सवरच काम करते!',
	'upload_control_text' => 'कृपया नविन विकि-मजकूर तपासा व जर सर्व आलबेल असेल तर "$1" टिचका!',
	'error_commons_user' => 'बदली करणाऱ्या सदस्यास ओळखण्यास,आपले विकिमीडिया कॉमन्स सदस्यनाम वर्णनात हवे!',
	'error_upload_users' => 'चाचणी कालावधीत,अपभारण फक्त मर्यादित सदस्यांनाच उपलब्ध आहे!',
	'error_upload_file' => 'मुळ संचिकेचे अधिभारण(डाउनलोड) करता आले नाही.',
	'help_intro' => 'जर आपणास गणकदोषाची माहिती द्यायची असेल,एखादे प्रारुप सुचवायचे असेल किंवा आपणास एखादा प्रश्न पडला असेल तर, आपण खालीलपैकी एखादा संपर्कप्रकार वापरू शकता:',
	'help_jira' => '$1JIRA (आपले खाते हवे)$2 (Project: Commonshelper2)',
...
$messages['sr-ec'] = array(
	...
	'description' => 'Алатка за пренос датотека из Викимедијиних пројеката у Оставу',
	'change_meta' => 'Промените $1поставке категорија и шаблона$2 за $3',
	'jira_link' => 'Пријавите грешку или предложите нову могућност',
	'language' => 'Језик',
	'project' => 'Пројекат',
	'source_file' => 'Изворна датотека',
	'target_file' => 'Одредишна датотека',
	'commons_username' => 'Корисничко име на Остави',
	'commons_to_project' => 'Из Оставе у пројекат',
	'move_file_from_com' => 'Премести датотеку из Оставе у пројекат',
	'categories' => 'Категорије',
	'remove_cats' => 'Уклони постојеће категорије',
	'checkusage' => 'Провера употребе',
	'use_checkusage' => 'Користи $1CommonSense$2 за предлагање нових категорија',
	'use_tusc' => 'Користи $1TUSC$2 за проверу идентитета и директан пренос датотеке',
	'tusc_user' => 'Корисничко име TUSC-а',
	'tusc_pass' => 'Лозинка TUSC-а',
	'do_it' => 'Изврши',
	'error_transfer_usr' => 'Нисте поставили корисничко име на Остави',
	'error_not_exists' => 'Изворна датотека не постоји.',
	'error_on_commons' => 'Изворна датотека је већ на $1.',
	'error_file_exists' => 'Датотека већ постоји на викију $3 под именом „$1$4$2“.',
	'error_diff_exists' => 'На наведеном викију постоји другачија одредишна датотека с истим именом.',
	'error_no_meta' => 'Метаподаци о изворном викију нису пронађени. $1Додајте или ажурирајте метаподатке за пројекат$2',
	'error_meta_no_good' => 'Метаподаци: пронађени су лоши шаблони. $1Додајте или ажурирајте метаподатке за пројекат$2',
	'error_meta_bad' => 'Метаподаци: пронађен је лош шаблон. $1Додајте или ажурирајте метаподатке за пројекат$2',
	'original_wikitext' => 'Изворни вики текст',
	'new_wikitext' => 'Нови вики текст',
	...
	'target_wiki' => 'одредишни вики',
	'standard_project' => 'Википедија',
	'error_bot_blocked' => 'Бот за отпремање је блокиран на Остави.',
	'error_upload_meta' => 'Не могу директно да отпремим јер је дошло до проблема са метаподацима (погледајте изнад).',
	'error_tusc_failed' => 'Провера TUSC-а није успела',
	'error_only_commons' => 'Директно отпремање ради само на Остави.',
	'upload_control_text' => 'Проверите нови вики текст, и ако је све у реду, кликните на „$1“.',
	'error_commons_user' => 'Да бисмо препознали корисника који преноси датотеке, ваше корисничко име на Остави мора бити у опису.',
	'error_upload_users' => 'Функција за отпремање у пробном периоду доступна је само извесним корисницима.',
	...
	'help_jira' => '$1JIRA (потребан вам је налог)$2 (пројекат: Commonshelper2)',
	'help_mail' => 'Пошаљите е-поруку на $1',
	'help_commons' => '$1Објавите поруку на Остави$2',
);
...
$messages['zh-hant'] = array(
	...
	'commons_to_project' => '維基共享資源到專案',
	'move_file_from_com' => '由維基共享資源轉移檔案到專案',
	'categories' => '分類',
	'remove_cats' => '刪除現有的分類',
	'checkusage' => 'CheckUsage',
