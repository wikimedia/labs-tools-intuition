...
$messages['bn'] = array(
	...
	'introduction' => 'একটি টেমপ্লেটের (এই মুহূর্তে শুধুমাত্র উইকিপিডিয়া) নাম লিখুন এবং চলো-তে ক্লিক করুন। এটি তার থেকেও সহজ। এখানে কিছু ক্যাশে রয়েছে (ফলাফল মনে রাখার জন্য), কিন্তু এটি দুর্ভাগ্যবশত এই সরঞ্জাম ও তার মালিকের নিয়ন্ত্রণের বাইরে।',
	'language-label' => 'ভাষা',
	'namespace-label' => 'নামস্থান',
...
$messages['fa'] = array(
	...
	'introduction' => 'در نام یک الگو بنویسید (فقط ویکی‌پدیاها) و دکمه برو را بفشارید. به همین سادگی بود. تعدادی دریافت (نتیجه را به خاطر می‌سپارند) ولی متأسفانه خارج از دسترس ابزار و مالک آن است.',
	'language-label' => 'زبان',
...
$messages['sr-ec'] = array(
	...
	'enter-details' => 'Унесите податке',
	'introduction' => 'Унесите име шаблона (за сада само за Википедију) и кликните на „Иди“. Биће извршено и привремено складиштење (да би се запамтили резултати), али то је, нажалост, ван контроле ове алатке и његовог власника.',
	'language-label' => 'Језик',
	'namespace-label' => 'Именски простор',
	'pagename-label' => 'Име странице (без именског простора)',
	'transclusion-count-label' => 'Број укључивања',
	'transclusion-count' => 'Пронађено је $1 укључивања.',
...
$messages['zh-hant'] = array(
	...
	'pagename-label' => '頁面名稱 （不包括命名空間）',
	'transclusion-count-label' => '使用數目',
	'transclusion-count' => '找到在$1頁上使用。',
	'error-suggestion' => '可能你打錯頁面的標題？', # Fuzzy
