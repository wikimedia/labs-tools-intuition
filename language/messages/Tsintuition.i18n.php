...
$messages['en'] = array(
	...
	'bl-changelanguage' => 'Change the interface language of this tool.',
...
$messages['af'] = array(
	...
	'current-language' => 'Huidig gekose taal', # Fuzzy
...
$messages['as'] = array(
	...
	'bl-changelanguage' => 'এই সঁজুলিৰ ইন্টাৰফেছ ভাষা পৰিৱর্তন কৰিবলৈ ইয়াত ক্লিক কৰক।', # Fuzzy
...
$messages['ast'] = array(
	...
	'current-language' => 'Llingua seleicionada',
	...
	'bl-changelanguage' => "Camudar la llingua de la interfaz d'esta ferramienta.",
...
$messages['azb'] = array(
	...
	'current-language' => 'ایندیکی سئچیلمیش دیل', # Fuzzy
	...
	'bl-changelanguage' => 'بو آراجین آرا-اوز دیلینی چئویرمک اوچون بورانی تیکلایین.', # Fuzzy
...
$messages['ba'] = array(
	...
	'current-language' => 'Ағымдағы тел көйләүҙәре', # Fuzzy
	...
	'bl-changelanguage' => 'Был ҡорамалда интерфейс телен үҙгәртеү өсөн ошонда баҫығыҙ.', # Fuzzy
...
$messages['be'] = array(
	...
	'current-language' => 'Цяперашняя выбраная мова', # Fuzzy
	...
	'bl-changelanguage' => 'Націсніце тут для змены мовы для гэтай прылады', # Fuzzy
...
$messages['be-tarask'] = array(
	...
	'bl-changelanguage' => 'Націсьніце, каб зьмяніць мову інтэрфэйсу гэтага інструмэнта.', # Fuzzy
...
$messages['bg'] = array(
	...
	'current-language' => 'Текущо избран език', # Fuzzy
 ...
 */
$messages['bn'] = array(
	'fullname' => 'সরঞ্জামের ইন্টারফেসের আন্তর্জাতিকীকরণ',
	'current-settings' => 'বর্তমান সেটিংস',
	'current-language' => 'নির্বাচিত ভাষা',
	...
	'bl-changelanguage' => 'এই সরঞ্জামটির ইন্টারফেস ভাষা পরিবর্তন করুন।',
	'usage' => 'সরঞ্জামগুলো ইনট্যুইশনের সহায়তায় অনূদিত হয়েছে।',
	'help-translate-tool' => 'এই টুলটি অনুবাদে সাহায্য করুন!',
	'help-translate-all' => 'সরঞ্জাম অনুবাদে সাহায্য করুন!',
...
$messages['br'] = array(
	...
	'bl-changelanguage' => 'Cheñch yezh etrefas an ostilh-mañ.',
...
$messages['bs'] = array(
	...
	'current-language' => 'Trenutno odabrani jezik', # Fuzzy
	...
	'bl-changelanguage' => 'Kliknite ovdje za promjenu jezika interfejsa za ovaj alat.', # Fuzzy
);
 ...
 */
$messages['ce'] = array(
	'fullname' => 'Интеркъаьмнийн гӀирс бан',
	'current-settings' => 'Карара гӀирс нисбарш',
	'current-language' => 'Хаьржина мотт',
	'settings-legend' => 'Параметраш',
	'choose-language' => 'Харжа мотт',
	'clear-cookies' => 'ДӀаяккха Cookies',
	'renew-cookies' => 'Карлаяккха Cookies',
	'cookie-expiration' => 'Файла cookie леларан хан',
	'clearcookies-success' => 'Cookies файлаш кхиамца дӀацӀанйина.',
	'renewcookies-success' => 'Cookie карлаяьхина! ХӀоттина хан $1',
	'tab-overview' => 'Гучé',
	'tab-settings' => 'Параметраш',
	'tab-about' => 'Цуьнах лаьцна',
	'tab-demo' => 'Демо',
	'bl-mysettings' => 'Сан мотт дIахIотторш',
	'bl-mysettings-new' => 'Харжа мотт',
	'bl-promo' => 'Гочйина гӀоьнца $1 а $2 а.',
	'bl-changelanguage' => 'ХӀокху гӀирсан интерфейсан мотт хийца.',
	'usage' => 'Intuition гӀоьнца гочбина гӀирсаш.',
	'help-translate-tool' => 'ГӀодеш хӀара гӀирс гочбан!',
	'help-translate-all' => 'ГӀодеш хӀара гӀирсаш гочбан!',
	'help-translate-tooltip' => 'ГӀодеш кхечу кепара гӀирс гочбан шайн матте.',
);
...
$messages['cs'] = array(
	...
	'current-language' => 'Aktuálně vybraný jazyk', # Fuzzy
	...
	'bl-changelanguage' => 'Kliknutím zde změníte jazyk rozhraní tohoto nástroje.', # Fuzzy
...
$messages['cv'] = array(
	...
	'current-language' => 'Хальхи чӗлхе ӗнерленӗвӗсем', # Fuzzy
	...
	'bl-changelanguage' => 'Ку хатӗрӗн интерфейс чӗлхине улӑштарасшӑн кунта пусӑр.', # Fuzzy
...
$messages['da'] = array(
	...
	'current-language' => 'Valgte sprog', # Fuzzy
	...
	'bl-changelanguage' => 'Klik her for at ændre sproget i brugergrænsefladen for ​​dette værktøj.', # Fuzzy
...
$messages['de'] = array(
	...
	'current-language' => 'Ausgewählte Sprache',
...
$messages['diq'] = array(
	...
	'current-language' => 'Zıwano ke newke weçineyayo', # Fuzzy
	'settings-legend' => 'Eyari',
	'choose-language' => 'Yew zıwan weçine',
...
$messages['dsb'] = array(
	...
	'current-language' => 'Tuchylu wubrana rěc', # Fuzzy
	...
	'bl-changelanguage' => 'Klikni how, aby rěc wužywarskego powjercha toś togo rěda změnił.', # Fuzzy
...
$messages['el'] = array(
	...
	'current-language' => 'Τρέχουσα επιλεγμένη γλώσσα', # Fuzzy
	...
	'bl-changelanguage' => 'Κάντε κλικ εδώ για να αλλάξετε την γλώσσα αυτού του εργαλείου.', # Fuzzy
...
$messages['eo'] = array(
	...
	'current-language' => 'Elektita lingvo',
...
$messages['es'] = array(
	...
	'clearcookies-success' => 'Se han eliminado las cookies.',
	...
	'bl-changelanguage' => 'Cambiar el idioma de la interfaz de esta herramienta.',
	'usage' => 'Herramientas traducidas por Intuition.',
 ...
 */
$messages['et'] = array(
	'fullname' => 'Tööriistade tõlkimine ja kohandamine',
	'current-settings' => 'Praegused sätted',
	'current-language' => 'Valitud keel',
	...
	'bl-changelanguage' => 'Muuda selle tööriista liidese keelt.',
	'usage' => 'Intuitioni abil tõlgitavad tööriistad.',
	'help-translate-tool' => 'Aita seda tööriista tõlkida!',
	'help-translate-all' => 'Aita tööriistu tõlkida!',
...
$messages['eu'] = array(
	...
	'current-language' => 'Orain aukeratutako hizkuntza', # Fuzzy
...
$messages['fa'] = array(
	...
	'bl-changelanguage' => 'تغییر زبان رابط  ابزار',
...
$messages['fi'] = array(
	...
	'current-language' => 'Tällä hetkellä valittu kieli', # Fuzzy
	...
	'bl-changelanguage' => 'Vaihda käyttöliittymän kieltä napsauttamalla tästä.', # Fuzzy
...
$messages['fo'] = array(
	...
	'current-language' => 'Valt mál í løtuni', # Fuzzy
	...
	'bl-changelanguage' => 'Trýst her fyri at broyta málið á markamótinum (interface) hjá hesum tólinum.', # Fuzzy
...
$messages['fr'] = array(
	...
	'current-language' => 'Langue sélectionnée',
...
$messages['frp'] = array(
	...
	'current-language' => 'Lengoua ora chouèsia', # Fuzzy
...
$messages['gl'] = array(
	...
	'current-settings' => 'Configuración actual',
	'current-language' => 'Lingua actual', # Fuzzy
	...
	'bl-changelanguage' => 'Prema aquí para cambiar a lingua da interface da ferramenta.', # Fuzzy
...
$messages['gu'] = array(
	...
	'current-language' => 'હાલમાં પસંદ કરાયેલ ભાષા', # Fuzzy
...
$messages['hi'] = array(
	...
	'current-language' => 'वर्तमान चयनित भाषा', # Fuzzy
	...
	'bl-changelanguage' => 'इस टूल की अंतरफल भाषा बदलने के लिये यहाँ क्लिक करें।', # Fuzzy
...
$messages['hr'] = array(
	...
	'current-settings' => 'Trenutne postavke',
	'current-language' => 'Trenutačno odabrani jezik', # Fuzzy
	'settings-legend' => 'Postavke',
	...
	'bl-changelanguage' => 'Kliknite ovdje za promjenu jezika sučelja za ovaj alat.', # Fuzzy
...
$messages['hsb'] = array(
	...
	'current-settings' => 'Aktualne nstajenja',
	'current-language' => 'Tuchwilu wubrana rěč', # Fuzzy
	'settings-legend' => 'Nastajenja',
	...
	'bl-changelanguage' => 'Klikń tu, zo by rěč wužiwarskeho powjercha tutoho nastroja změnił.', # Fuzzy
...
$messages['ia'] = array(
	...
	'current-language' => 'Lingua actualmente seligite', # Fuzzy
	'settings-legend' => 'Configuration',
	...
	'bl-changelanguage' => 'Clicca hic pro cambiar le lingua del interfacie de iste instrumento.', # Fuzzy
 ...
 */
$messages['id'] = array(
	'fullname' => 'Internasionalisasi peralatan',
	'current-settings' => 'Setelan sekarang',
	'current-language' => 'Bahasa pilihan',
	...
	'bl-changelanguage' => 'Ganti bahasa antarmuka alat ini.',
...
$messages['it'] = array(
	...
	'current-language' => 'Lingua selezionata',
...
$messages['ja'] = array(
	...
	'bl-changelanguage' => 'このツールのインターフェイス言語を変更するにはここをクリックしてください。', # Fuzzy
...
$messages['jv'] = array(
	...
	'current-language' => 'Basa pinilih saiki', # Fuzzy
	...
	'bl-changelanguage' => 'Klik kéné kanggo ngganti basané antarmuka saka piranti iki.', # Fuzzy
...
$messages['km'] = array(
	...
	'current-language' => 'ភាសាដែលបានជ្រើសរើសបច្ចុប្បន្ននេះ', # Fuzzy
	...
	'bl-changelanguage' => 'ចុចនៅទីនេះដើម្បីផ្លាស់ប្ដូរភាសានៃឧបករណ៍នេះ។', # Fuzzy
...
$messages['ko'] = array(
	...
	'current-language' => '현재 선택한 언어', # Fuzzy
	'settings-legend' => '설정',
	...
	'bl-changelanguage' => '도구의 인터페이스 언어를 바꾸러면 여기를 클릭하세요.', # Fuzzy
...
övversaz woode sin.',
	...
	'help-translate-tooltip' => 'Donn der Andere jet Joods un donn de Täxte un Nohreeschte vun de Projramme en Ding Schprohch övversäze.',
);
...
$messages['lb'] = array(
	...
	'current-language' => 'Erausgesicht Sprooch',
...
$messages['lrc'] = array(
	...
	'current-language' => 'زون تازه باو انتخاو بیه', # Fuzzy
	...
	'bl-changelanguage' => 'ایچه بپورنیت تا راوط زون ای اوزار آلشت بوئه', # Fuzzy
...
$messages['lt'] = array(
	...
	'current-language' => 'Šiuo metu pasirinkta kalba', # Fuzzy
	...
	'bl-changelanguage' => 'Spauskite čia, norėdami pakeisti šios priemonės kalbą.', # Fuzzy
...
$messages['mr'] = array(
	...
	'current-language' => 'सध्या निवडलेली भाषा', # Fuzzy
	...
	'bl-changelanguage' => 'या साधनाचे इंतरफेस भाषा बदलण्यास येथे टिचकी द्या.', # Fuzzy
...
$messages['ms'] = array(
	...
	'current-language' => 'Bahasa yang dipilih',
	...
	'bl-changelanguage' => 'Tukar bahasa antaramuka alat ini.',
...
$messages['mt'] = array(
	...
	'current-language' => 'Lingwa magħżula bħalissa', # Fuzzy
	...
	'bl-changelanguage' => "Iklikkja hawnhekk sabiex tbiddel il-lingwa tal-interfaċċa ta' din l-għodda", # Fuzzy
...
$messages['mzn'] = array(
	...
	'current-settings' => 'تنظیمات کنونی',
	'current-language' => 'انتخاب بَیی زوون', # Fuzzy
	'settings-legend' => 'تنظیمات',
...
$messages['nb'] = array(
	...
	'current-language' => 'Valgt språk', # Fuzzy
	...
	'bl-changelanguage' => 'Klikk her for å endre grensesnittspråket for dette verktøyet.', # Fuzzy
 ...
 */
$messages['ne'] = array(
	'settings-legend' => 'सेटिङ्हरू',
	'choose-language' => 'भाषा चुन्ने',
	'clear-cookies' => 'कुकीहरू हटाउने',
	'renew-cookies' => 'कुकीहरू रुजु गर्ने',
	'cookie-expiration' => 'कुकी समाप्ती',
	'clearcookies-success' => 'कुकीहरू हटाइयो ।',
	'tab-overview' => 'पूर्णावलोकन',
	'tab-settings' => 'सेटिङ्हरू',
	'tab-about' => 'बारेमा',
	'tab-demo' => 'प्रस्तुती',
);
...
$messages['new'] = array(
	...
	'current-language' => 'आः ल्ययातःगु भाय्', # Fuzzy
	...
	'bl-changelanguage' => 'थ्व ज्याभःया इन्तरफेस भाय् हिलेत थन तियादिसँ।', # Fuzzy
...
$messages['nl'] = array(
	...
	'renew-cookies' => 'cookies vernieuwen',
...
$messages['nn'] = array(
	...
	'current-language' => 'Valt språk', # Fuzzy
	'settings-legend' => 'Innstillingar',
	...
	'bl-changelanguage' => 'Trykk her for å byta språket i brukarflata til verktyet.', # Fuzzy
...
$messages['oc'] = array(
	...
	'current-language' => 'Lenga seleccionada',
...
$messages['or'] = array(
	...
	'current-language' => 'ବର୍ତ୍ତମାନ ବାଛିଥିବା ଭାଷା', # Fuzzy
	...
	'bl-changelanguage' => 'ଏହି ଟୁଲର ଭାଷା ବଦଳାଇବା ପାଇଁ ଏଠାରେ କ୍ଲିକ କରନ୍ତୁ ।', # Fuzzy
...
$messages['pfl'] = array(
	...
	'current-language' => 'Agduell gwehldi Schbrooch', # Fuzzy
	...
	'bl-changelanguage' => 'Do drigge, um die Schbrooch fa des Weagzaisch do zu änare.', # Fuzzy
...
$messages['pl'] = array(
	...
	'current-language' => 'Wybrany język',
...
$messages['pms'] = array(
	...
	'current-language' => 'Lenga selessionà al moment', # Fuzzy
	...
	'bl-changelanguage' => "Ch'a sgnaca ambelessì për cangé le lenga dl'antërfacia ëd s'utiss.", # Fuzzy
...
$messages['ps'] = array(
	...
	'current-language' => 'د دم مهال ټاکلې ژبه', # Fuzzy
...
$messages['pt'] = array(
	...
	'current-language' => 'Idioma selecionado',
...
$messages['pt-br'] = array(
	...
	'current-language' => 'Idioma selecionado atualmente', # Fuzzy
	...
	'bl-promo' => 'Traduções possíveis graças à $1 e ao $2.',
	'bl-changelanguage' => 'Clique aqui para alterar o idioma da interface desta ferramenta.', # Fuzzy
...
$messages['ro'] = array(
	...
	'current-language' => 'Limbă selectată',
...
$messages['si'] = array(
	...
	'current-language' => 'වත්මන් තෝරාගත් භෂාව', # Fuzzy
	...
	'bl-changelanguage' => 'මෙම මෙවලමේ අතුරුමුහුණත් භාෂාව වෙනස් කිරීම සඳහා මෙතන ක්ලික් කරන්න.', # Fuzzy
...
$messages['sl'] = array(
	...
	'bl-changelanguage' => 'Spremenite jezik vmesnika tega orodja.',
...
$messages['so'] = array(
	...
	'current-language' => 'Luqada ee la doortay hadda', # Fuzzy
	...
	'bl-changelanguage' => 'Guji halkaan si aad ubadasho luqada ee waafaqsan qalabkaan', # Fuzzy
...
$messages['sq'] = array(
	...
	'current-language' => 'Gjuha e përzgjedhur aktualisht', # Fuzzy
	...
	'bl-changelanguage' => 'Klikoni këtu për të ndryshuar gjuhën e ndërfaqes të kësaj vegle.', # Fuzzy
...
$messages['sr-el'] = array(
	...
	'current-language' => 'Izabrani jezik', # Fuzzy
	'settings-legend' => 'Postavke',
	...
	'bl-changelanguage' => 'Kliknite ovde da promenite jezik alatke', # Fuzzy
...
$messages['sv'] = array(
	...
	'renewcookies-success' => 'Kakor förnyade! Du är klar för de nästa $1.',
...
$messages['sw'] = array(
	...
	'current-language' => 'Lugha iliyochaguliwa kwa sasa', # Fuzzy
 ...
 */
$messages['ta'] = array(
	'fullname' => 'கருவிகளுக்கான உலகமயமாக்கல்',
	'current-settings' => 'தற்போதைய அமைப்புகள்',
	'current-language' => 'தேர்வு செய்யப்பட்டுள்ள மொழி',
	...
	'bl-changelanguage' => 'இக்கருவியின் இடைமுகப்பு மொழியை மாற்றவும்.',
	'help-translate-tool' => 'இந்த கருவியை மொழிபெயர்க்க உதவுக',
	'help-translate-all' => 'கருவிகளை மொழிபெயர்க்க உதவுக!',
...
$messages['te'] = array(
	...
	'current-language' => 'ప్రస్తుతం ఎంచుకున్న భాష', # Fuzzy
	...
	'bl-changelanguage' => 'ఈ పనిముట్టు ముఖాంతరపు భాషను మార్చడానికి ఇక్కడ నొక్కండి.', # Fuzzy
...
$messages['tl'] = array(
	...
	'current-language' => 'Pangkasalukuyang napiling wika', # Fuzzy
	...
	'bl-changelanguage' => 'Pindutin dito upang baguhin anng wika ng ugnayang-mukha ng kasangkapang ito.', # Fuzzy
...
$messages['tr'] = array(
	...
	'current-language' => 'Halihazırda seçilmiş dil', # Fuzzy
	...
	'bl-changelanguage' => 'Bu aracın arayüz dilini değiştirmek için buraya tıklayın.', # Fuzzy
...
$messages['ug-arab'] = array(
	...
	'current-language' => 'نۆۋەتتە تاللانغان تىل', # Fuzzy
	...
	'bl-changelanguage' => 'بۇ جاينى چېكىپ مەزكۇر قورالنىڭ ئارايۈز تىلىنى ئۆزگەرتىڭ.', # Fuzzy
...
$messages['uk'] = array(
	...
	'bl-changelanguage' => 'Змінює мову інтерфейсу цього інструмента.',
...
$messages['zh-hant'] = array(
	...
	'current-language' => '當前所選的語言', # Fuzzy
	'settings-legend' => '設定',
	...
	'bl-promo' => '翻譯來自 $1 和 $2 。',
	'bl-changelanguage' => '按此更改此工具的界面語言。', # Fuzzy
...
$messages['zh-hk'] = array(
	...
	'bl-mysettings-new' => '更改語言！',
	'bl-promo' => '翻译由$1及$2提供。',
	'bl-changelanguage' => '若要更改此工具的介面語言，請按此處。', # Fuzzy
	'usage' => '由Toolserver Intuition翻譯的工具。', # Fuzzy
	'help-translate-tool' => '協助翻譯此工具 ！',
	'help-translate-all' => '協助翻譯Toolserver！', # Fuzzy
	'help-translate-tooltip' => '幫助其他人把界面翻譯成您的語言。',
