...
$messages['fa'] = array(
	...
	'settings_show' => 'نمایش',
	'settings_wiki' => 'ویکی',
	'settings_bot_edits' => 'ویرایش‌های ربات',
	'settings_anon_edits' => 'ویرایش‌های ناشناس',
	'settings_minor_edits' => 'ویرایش‌های جزئی',
	'settings_redirects' => 'صفحهٔ تغییرمسیر',
	'settings_new_pages' => 'صفحه‌های تازه',
	'settings_editor_edits' => 'ویرایش‌های ویرایش‌کننده',
	'settings_admin_edits' => 'مدیر ویرایش‌ها',
	'settings_other_edits' => 'ویرایش‌های دیگر',
	'time_utc' => 'زمان در UTC',
	'stat_articles' => 'صفحه‌های محتوایی',
	'stat_pages' => 'صفحه‌ها',
	'stat_files' => 'پرونده‌های بارگذاری‌شده',
	'stat_edits' => 'ویرایش‌های صفحه',
	'stat_depth' => 'عمق',
	'stat_users' => 'کاربران ثبت‌شده',
	'stat_active_users' => 'کاربران فعال',
	'stat_admins' => 'مدیران',
	'separator_thousands' => '،',
	'separator_decimals' => '.',
	'def_i' => 'v conv',
	'def_def' => 'بازرس؛ نگهبان؛ گشت؛',
	'main_time_utc' => 'زمان (UTC)',
	'main_page' => 'صفحه',
	'main_user' => 'کاربر',
	'main_info' => 'اطلاعات',
	'combined_entries' => 'نوشته‌های ترکیبی',
	'new' => 'تازه',
	'minor' => 'جزئی',
	'anon' => 'ناشناس',
	'redirect' => 'تغییرمسیر',
	...
	'editor' => 'ویرایشگر',
	'admin' => 'مدیر',
	'help_p1' => 'Raun ابزاری برای گشت‌زنی تغییرات اخیر پروژه‌های بنیاد مدیاویکی است. Raun تغییرات اخیر را بارگیری می‌کند و به صورت خودکار آن را به شما نمایش می‌دهد.',
	'help_p2' => 'باز زدن دکمهٔ "توقف" ابزار را متوقف کرده‌اید و بعد از آن با زدن دکمهٔ "اجرا" می‌توانید آن را اجرا کنید.',
	'help_p3' => 'با "پالایه" می توانید ویرایش‌ها را پالایش کنید و ویکی‌پروژه یا زبان را در بخش تنظیمات می‌توانید تغییر دهید.',
	'help_p4' => 'ردیف‌های دارای متن خاکستری به این معنی است که ویرایش‌های جدید در آن صفحه انجام شده‌است.',
	'help_legend' => 'علائم:',
	'color' => 'رنگ',
	'about' => 'درباره',
	'about_tool' => 'Raun ابزاری است که تغییرات اخیر را به صورت زنده به شما نمایش می‌دهد این ابزار از $1 توسط $2 توسعه یافته. این پروژه توسط $3 شروع شده‌است.',
	'about_cookie' => 'این وب‌گاه از کوکی استفاده می‌کند. اگر ابزار را طی ۳۰ روز آینده مشاهده نکنید اطلاعات ذخیره شده در کوکی‌ها حذف می‌شوند.',
	'information' => 'اطلاعات',
	'credit' => 'اعتبار',
	'about_license' => 'کدهای این پروژه تحت مجوز ام‌آی‌تی هستند.',
	'about_github' => 'کد منبع در $1 دسترس است',
...
$messages['ksh'] = array(
	...
	'time_utc' => 'De <i lang="en" xml:lang="en" title="Universal Time Controlled">UTC</i> Zigg',
	'stat_articles' => 'Sigge vum Enhalt',
	'stat_pages' => 'Sigge',
	...
	'separator_thousands' => '&nbsp;',
	'separator_decimals' => '.',
	'main_time_utc' => 'De Zigg (<i lang="en" xml:lang="en" title="Universal Time Controlled">UTC</i>)',
	'main_page' => 'Sigg',
	...
	'credit' => 'Aanerkennong för Beidrääsch', # Fuzzy
	'about_github' => 'Der Quälltäx es ze han op $1',
...
$messages['ms'] = array(
	...
	'fork' => 'Kod sumber',
	'stat' => 'Statistik',
	'settings_tool' => 'Alatan',
	'language' => 'Bahasa',
	'project' => 'Projek',
	'save' => 'Simpan',
	'settings_pause' => 'Jedakan',
	'settings_run' => 'Jalankan!',
	'settings_show' => 'Tunjukkan',
	'settings_wiki' => 'Wiki',
	'settings_bot_edits' => 'Suntingan bot',
	'settings_anon_edits' => 'Suntingan tanpa nama',
	'settings_minor_edits' => 'Suntingan kecil',
	'settings_redirects' => 'Laman lencongan',
	'settings_new_pages' => 'Laman baru',
	'settings_editor_edits' => 'Suntingan editor',
	'settings_admin_edits' => 'Suntingan penyelia',
	'settings_other_edits' => 'Suntingan lain',
	'time_utc' => 'Waktu, pada UTC',
	'stat_articles' => 'Laman kandungan',
	'stat_pages' => 'Laman',
	'stat_files' => 'Fail yang dimuat naik',
	'stat_edits' => 'Suntingan laman',
	'stat_depth' => 'Paras',
	'stat_users' => 'Pengguna berdaftar',
	'stat_active_users' => 'Pengguna aktif',
	'stat_admins' => 'Penyelia',
	'separator_thousands' => ',',
	'separator_decimals' => '.',
	'main_time_utc' => 'Waktu (UTC)',
	'main_page' => 'Laman',
	...
	'editor' => 'editor',
	'admin' => 'penyelia',
	'help_p1' => 'Raun ialah alat untuk meronda perubahan terkini pada wiki -wiki Projek Yayasan Wikimedia secara langsung. Raun akan memuatkan perubahan terkini dari masa ke semasa dan menunjukkannya di hadapan anda secara automatik.',
	'help_p2' => 'Anda boleh menjedakan alat ini dengan mengklik "Jeda". Dan selepas itu, anda boleh menjalankannya lagi dengan mengklik "Jalankan!".',
	'help_p3' => 'Anda boleh menapis suntingan yang anda ingin lihat di "Penapis", dan tetapan projek wiki, bahasa wiki, dan bahasa alat ini di "Tetapan".',
	'help_p4' => 'Baris dengan teks berwarna kelabu bermakna terdapat suntingan lain yang lebih baru di laman tersebut.',
	'help_legend' => 'Petunjuk:',
	'color' => 'Warna',
	'about' => 'Perihal',
	'about_tool' => 'Raun ialah alat untuk meronda perubahan terkini dari projek Yayasan Wikimedia secara langsung. Alat ini diilhamkan daripada $1, oleh $2. Projek ini dimulakan oleh $3.',
	'about_cookie' => 'Laman web ini menggunakan cookies. Data yang disimpan oleh cookie akan dihapuskan secara automatik jika anda tidak melawat alat ini dalam 30 hari.',
	'information' => 'Maklumat',
	'credit' => 'Kredit',
	'about_license' => 'Dinyatakan sebaliknya, kod sumber projek ini dilesenkan di bawah Lesen MIT.',
	'about_github' => 'Kod sumber boleh didapati pada $1',
	'send_feedback' => 'Kirim maklum balas',
);
...
$messages['nl'] = array(
	...
	'editor' => 'redacteur',
	'admin' => 'beheerder',
	'help_p1' => 'Raun is een hulpmiddel om de recente wijzigingen op projecten van de Wikimedia Foundation in realtime te volgen. Raun laadt de recente wijzigingen periodiek en laat ze automatisch aan u zien.',
	'help_p2' => 'U kunt dit hulpmiddel pauzeren door op "Pauzeren" te klikken. Daarna kunt u het weer activeren door op "Uitvoeren!" te klikken.',
	'help_p3' => 'U kunt de bewerkingen die u wilt zien filteren onder "Filter" en u kunt het wikiproject of de taal van dit programma wijzigen onder "Instellingen".',
	'help_p4' => 'Als een rij grijze tekst heeft, betekent dat dat er nieuwere bewerkingen zijn voor die pagina.',
	'help_legend' => 'Legenda:',
	'color' => 'Kleur',
	'about' => 'Over',
	'about_tool' => 'Raun is een hulpmiddel om de recente wijzigingen op projecten van de Wikimedia Foundation te volgen in (bijna) realtime. Dit hulpmiddel is gemaakt door $2, met inspiratie van $1. Het project is gestart door $3.',
	'about_cookie' => 'Deze site maakt gebruik van cookies. Gegevens die zijn opgeslagen via de cookies worden automatisch verwijderd als u de website niet binnen 30 dagen weer bezoekt.',
...
$messages['ru'] = array(
	...
	'editor' => 'редактор',
	'admin' => 'админ',
	'help_p1' => 'Raun — это инструмент для слежения за последними изменениями в проектах Фонда Викимедиа практически в реальном времени. Raun периодически подгружает последние изменения и автоматически показывает их вам.',
	...
	'about_cookie' => 'Этот сайт использует куки. Данные, хранящиеся в них, будут удалены автоматически, если вы не будете заходить на страницу этого инструмента в течение 30 дней.',
	'information' => 'Информация',
	'credit' => 'Использованы',
	'about_license' => 'Иными словами, исходный код этого проекта распространяется под лицензией MIT.',
