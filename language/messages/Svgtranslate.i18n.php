...
$messages['ar'] = array(
	...
	'disclaimer' => 'سيتم جمع بعض البيانات المُجَهَّلَة لأغراض إحصائية، كما سيتم تسجيل أسماء مستخدمي OAuth - إن أُعطيت - للمعونة في حال وقوع تخريب. كلمات السِّرِّ لا يتم تسجيلها مطلقا.', # Fuzzy
...
$messages['azb'] = array(
	...
	'disclaimer' => 'بعضی تانیملانمامیش معلومات اؤزل اولاراق آمار اوچون ییغیلاجاق‌دیر. اگر وئریلسه، واندالیزمه قارشی یاردیم اولماق اوچون OAuth ایستیفاده‌چی آدی دا ثبت اولوناجاقدیر. رمزلر هئچ واخت ثبت اولمایاجاقلار.', # Fuzzy
...
$messages['ba'] = array(
	...
	'disclaimer' => 'Ҡайһы бер аноним мәғлүмәттәр статистика маҡсаты өсөн яҙыласаҡ. Әгәр OAuth-исем яҙылған булһа, вандализмға ҡаршы ярҙам өсөн яҙыласаҡ. Парольдәр бер касан да яҙылмай.', # Fuzzy
...
$messages['be'] = array(
	...
	'disclaimer' => 'Некаторыя ананімныя звесткі будуць збірацца для статыстычных мэтаў. Калі будуць пададзеныя, імёны ўдзельнікаў OAuth будуць таксама запісаныя ў мэтах абароны ад вандалізму. Паролі ніколі не будуць запісвацца.', # Fuzzy
...
$messages['be-tarask'] = array(
	...
	'disclaimer' => 'Некаторыя ананімныя зьвесткі будуць зьбірацца для статыстычных мэтаў. Калі будуць пададзеныя, імёны ўдзельнікаў OAuth будуць таксама запісаныя ў мэтах абароны ад вандалізму. Паролі ніколі не будуць запісвацца.', # Fuzzy
...
$messages['ca'] = array(
	...
	'disclaimer' => "Es recolliran de manera privada algunes dades anònimes amb una finalitat estadística. Quan s'hagin proporcionat, també es registraran els noms d'usuari d'OAuth per assistir en cas de vandalisme. Les contrasenyes no es conserven en cap cas.",
...
$messages['cs'] = array(
	...
	'disclaimer' => 'Pro statistické účely se sbírají jistá anonymní data. Při poskytnutí uživatelských jmen OAuth se tato zaznamenají pro případ nutnosti řešit vandalismus. Hesla se nezaznamenávají nikdy.',
...
$messages['da'] = array(
	...
	'disclaimer' => 'Nogle anonyme data vil blive indsamlet privat for at kunne føre statistik. Hvis det oplyses, vil OAuth-brugernavne også blive registreret til hjælp i tilfælde af hærværk. Adgangskoder vil aldrig blive registreret.', # Fuzzy
...
$messages['dsb'] = array(
	...
	'disclaimer' => 'Někotare anonymne daty zběraju se za statistiske zaměry. Jolic k dispoziciji, wužywarske mjenja OAuth so teke zapśimuju, ako pomocny srědk pśeśiwo wandalizmoju. Gronidła se nigda njezapśimuju.', # Fuzzy
...
$messages['et'] = array(
	...
	'disclaimer' => 'Osa nimeta andmeid kogutakse isiklikuks kasutamiseks statistilistel eesmärkidel. Ka OAuthi kasutajanimi talletatakse, kui selle sisestad, sest see on abiks võimaliku vandalismi korral. Paroole ei talletata kunagi.',
...
$messages['eu'] = array(
	...
	'disclaimer' => 'Datu anonimo batzuk jasoko dira hainbat estatistika egiteko. OAuth erabiltzaile izenak ere gordeak izango dira bandalismo ekintzak ekiditeko. Pasahitzak ez dira inoiz gordeko.', # Fuzzy
...
$messages['fa'] = array(
	...
	'th-password' => 'گذرواژه',
	'th-method' => 'روش',
	'option-oauth' => 'OAuth (بارگذاری خودکار)',
	...
	'disclaimer' => 'مقداری داده‌های ناشناس برای اهداف آماری جمع‌آوری خواهد شد. اگر ارائه شود، نام‌های کاربری OAuth برای کمک در هنگام خرابکاری ثبت خواهند شد. گذرواژه‌ها هیچ‌گاه ثبت نخواهند شد.',
...
$messages['fi'] = array(
	...
	'disclaimer' => 'Joitakin nimettömiä tietoja kerätään tilastokäyttöön. Annetut OAuth-käyttäjätunnukset tallennetaan häiriköinnin tutkintaa varten. Salasanoja ei koskaan tallenneta.', # Fuzzy
...
$messages['gl'] = array(
	...
	'disclaimer' => 'Recolleranse de xeito privado algúns datos anónimos para fins estatísticos. Se se proporcionaron, os nomes de usuario OAuth tamén se rexistrarán para axudar a combater o vandalismo. Os contrasinais non se gardan en ningún caso.', # Fuzzy
...
$messages['hr'] = array(
	...
	'disclaimer' => 'Neki anonimni podaci će se prikupljati u statističke svrhe. Ako je navedeno, OAuth suradnička imena također će biti zapisana kao pomoć u slučaju vandalizma. Lozinke nikada neće biti snimljene.', # Fuzzy
...
$messages['ia'] = array(
	...
	'disclaimer' => 'Certe datos anonyme essera colligite in private pro alimentar nostre statisticas. Si fornite, le nomines de usator de OAuth etiam essera registrate pro assister in caso de vandalismo. Le contrasignos nunquam essera registrate.', # Fuzzy
...
$messages['jv'] = array(
	...
	'disclaimer' => 'Sebagéyan data anonim bakal diklempakaké sacara pribadi kanggo panjangka statistik. Yèn sumadhiya, jeneng panganggo OAuth uga bakal direkam kanggo ngéwangi yèn ana kadadéan pangrusakan. Tembung sandhi ora bakal direkam.', # Fuzzy
...
$messages['km'] = array(
	...
	'disclaimer' => 'ទិន្នន័យខ្លះនឹងត្រូវបានប្រមូលទុកសំរាប់គោលបំណងខាងស្ថិតិ។ បើត្រូវបានផ្ដល់អោយ នោះអត្តនាម OAuth នឹងត្រូវបានកត់ត្រាទុកសំរាប់ការពារអំពើបំផ្លិចបំផ្លាញ​ជាសាធារណៈណាមួយ។ ពាក្យសំងាត់នឹងមិនត្រូវបានកត់ត្រាទុកជាដាច់ខាត។', # Fuzzy
...
$messages['kn'] = array(
	...
	'disclaimer' => 'ಅಂಕಿ ಅಂಶಗಳಿಗಾಗಿ ಕೆಲವು ಅನಾಮಧೇಯ ದತ್ತಾಂಶಗಳನ್ನು ಖಾಸಗಿಯಾಗಿ ಕಲೆಹಾಕಲಾಗುವುದು. OAuth ಸದಸ್ಯತ್ವದ ಹೆಸರು ನೀಡಿದರೆ, ವಿಧ್ವಂಸಕ ಘಟನೆಗಳಲ್ಲಿ ಸಹಕರಿಸಲು ಅವುಗಳನ್ನೂ ದಾಖಲಿಸಲಾಗುವುದು. ಗುಪ್ತಪದಗಳನ್ನು ಎಂದಿಗೂ ದಾಖಲಿಸಲಾಗುವುದಿಲ್ಲ.', # Fuzzy
...
$messages['ko'] = array(
	...
	'disclaimer' => '일부 익명의 데이터는 개인 통계 목적으로만 수집됩니다. 제공할 경우 반달 행위를 할 경우 도움이 되도록 OAuth 사용자 이름도 기록합니다. 비밀번호는 기록하지 않습니다.', # Fuzzy
...
$messages['ksh'] = array(
	...
	'disclaimer' => 'E paa Daate wääde för en Schtatistik faßjehallde, ävver nit öffentlesch jemaat, un se donn sesch och ob keine beschtemmpte Metmaacher beträcke. Wann se aanjejovve sin, wääde em <i lang="en">OAuth</i> sing Metmaachername faßjehallde, öm ze hällefe, falls ens Eine jät kapott jemaat hät. Paßwööter wääde nimohls faßjehallde.', # Fuzzy
...
$messages['lb'] = array(
	...
	'disclaimer' => "E puer anonym Donnéeë gi fir statistesch Zwecker gesammelt. Wann Dir en OAuth Benotzernumm ugëtt, gëtt deen och gespäichert fir am Fall vu Vandalismus d'Recherchen ze vereinfachen. Passwierder ginn ni gespäichert.",
...
$messages['lt'] = array(
	...
	'disclaimer' => 'Kai kurie anoniminiai duomenys bus privačiai renkami statistikos tikslais. Jei pateikėte, OAuth vardai taip pat bus registruojami dėl galimo vandalizmo. Slaptažodžiai niekada nebus įrašyti.', # Fuzzy
...
$messages['mk'] = array(
	...
	'translate-instructions' => 'Допуштено е да се внесуваат податотечни имиња (на пр. „$1“) или полни URL-адреси (на пр. „$2“). Ако го користите првото, за извор ќе се смета Ризницатата. Ако сакате да преведете SVG од друго мрежно место или вики, ќе мора да ја наведете полната URL-адреса.',
...
$messages['mr'] = array(
	...
	'error-notfound' => 'दिलेली SVG प्रकारची संचिका दिलेल्या संकेतस्थळावर हुडकता आलेली नाही.',
	...
	'disclaimer' => 'सांख्यिकीचे कामासाठी काही अनामिक माहिती खाजगीरित्या  गोळा केली जाईल.मिळाल्यास,उत्पाताच्या घटनेत OAuth सदस्यनावाचीही नोंद होईल.परवलीचा शब्द कधीच नोंदविल्या जाणार नाही.', # Fuzzy
...
$messages['nb'] = array(
	...
	'disclaimer' => 'Enkelte anonyme data vil samles inn privat for statistiske formål. Hvis oppgitt vil også OAuth-brukernavn bli registrert for å bistå i tilfelle hærverk. Passord vil aldri bli registrert.', # Fuzzy
...
$messages['nl'] = array(
	...
	'disclaimer' => 'Enkele anonieme gegevens worden niet-openbaar verzameld voor statistische doeleinden. Gebruikersnamen voor OAuth worden ook vastgelegd om in het geval van vandalisme te kunnen ingrijpen. Wachtwoorden worden nooit opgeslagen.',
...
$messages['no'] = array(
	...
	'upload-complete' => 'Opplastingen er fullført. Bildet bør nå være på $1',
	'editdescriptionpage' => 'Endre den nye beskrivelsessiden',
	'disclaimer' => 'Enkelte anonyme data vil samles inn privat for statistiske formål. Hvis oppgitt vil også OAuth-brukernavn bli registrert for å bistå i tilfelle hærverk. Passord vil aldri bli registrert.',
	'author-complete' => 'Fyll ut forfatterinformasjonen!',
	'preview-hide' => 'Skjul forhåndsvisning',
	'preview-refresh' => 'Oppdater forhåndsvisning',
	'error-must-accept' => 'For å fortsette med en direkte opplasting må du godta de oppgitte bruksvilkårene.',
...
$messages['pms'] = array(
	...
	'disclaimer' => "Chèich dat anònim a saran cujì ëd fasson privà për dij but statìstich. Se fornì, jë stranòm d'utent OAuth a saran ëdcò memorisà për giuté ant ij cas ëd vandalism. Le ciav a san mai memorisà.",
...
$messages['pt-br'] = array(
	...
	'disclaimer' => 'Alguns dados anônimos serão coletados de forma privada para fins estatísticos. Se for fornecido, os nomes de usuário OAuth também serão armazenado para auxílio em caso de vandalismo. As senhas nunca serão gravadas.',
...
$messages['so'] = array(
	...
	'disclaimer' => 'Waa la uruurinayaa macluumaadka qaar ee aan la aqoon si gaar ah iyadoo loola jeedo tirakoob ahaan. sidoo kale waxaa la diiwaan galinayaa magacyada isticmaala OAuth si loo caawiyo hadii ay dhacdo wax qarbudaad ah. Eraysirtana lama kaydin doono sideedaba.', # Fuzzy
...
$messages['sr-ec'] = array(
	...
	'error-tryagain' => '$1 Покушајте поново кликом на дугме „Назад“ у прегледачу.',
	'error-nothing' => 'Нема ништа за превођење.',
	'error-notsvg' => 'Ово није SVG датотека.',
	'error-unexpected' => 'Дошло је до неочекиване грешке.',
	'error-notfound' => 'Не могу да преузмем SVG датотеку из наведене URL адресе.',
	'error-upload' => 'Дошло је до грешке при отпремању.',
	'begin-translation' => 'Почните са превођењем',
	'th-original' => 'Изворно',
	'th-translation' => 'Превод',
	'th-language' => 'Језик',
	'th-username' => 'Корисничко име',
	...
	'preview' => 'Прегледај',
	'translate' => 'Преведи',
	'translate-instructions' => 'Допуштено је уношење имена датотеке (нпр. „$1“) или пуне URL адресе (нпр. „$2“). Ако изаберете прво, за извор ће се користити Остава. Ако желите да преведете SVG са другог сајта или викија, морате навести пуну URL адресу.',
	'svginput-label' => 'SVG датотека',
	'stats-footer' => 'Овом алатком досад је преведено око $1 датотека од $2.',
	'uploading' => 'Отпремам',
...
$messages['sr-el'] = array(
	...
	'disclaimer' => 'Neki anonimni podaci će biti skupljani u statističke svrhe. Ako je navedeno, OAuth korisnička imena će takođe biti zabeležena radi sprečavanja vandalizma. Lozinke se neće beležiti.', # Fuzzy
...
$messages['th'] = array(
	...
	'disclaimer' => 'ข้อมูลไม่ระบุตัวตน รวมไปถึงชื่อผู้ใช้งาน OAuth จะถูกเก็บรักษาเป็นความลับเพื่อประโยชน์ทางสถิติและป้องกันการก่อกวน อย่างไรก็ตามรหัสผ่านจะไม่มีการบันทึกแต่อย่างใด', # Fuzzy
...
$messages['tl'] = array(
	...
	'disclaimer' => 'Ilang datong hindi nakikilala ang pribadong lilikumin para sa mga layuning pang-estadistika.  Kapag ibinigay, ang mga pangalan ng tagagamit ng OAuth ay maitatala rin upang makatulong kapag may naganap na pambababoy. Hindi kailanman maitalala ang mga hudyat.', # Fuzzy
...
$messages['tr'] = array(
	...
	'disclaimer' => 'İstatistiksel amaçlarla bazı anonim bilgiler kaydedilecektir. Eğer belirtilirse, OAuth kullanıcı adları suiistimale karşı mücadelede kullanılacaktır. Şifreler asla kaydedilmeyecektir.',
...
$messages['ug-arab'] = array(
	...
	'disclaimer' => 'بەزى ئاتسىز سانلىق مەلۇماتلارنى شەخسلەر سىتاتىستىكا ئېلىپ بېرىش مەقسىتىدە توپلايدۇ. ئەگەر OAuth ئىشلەتكۈچى ئاتى ئىشلىتىلسە ئۇمۇ خاتىرىلىنىپ بۇزغۇنچىلىق قىلمىشىنىڭ ئالدىنى ئېلىشقا ھەمدەم قىلىنىدۇ. ئىم مەڭگۈ خاتىرىلەنمەيدۇ.', # Fuzzy
...
$messages['uk'] = array(
	...
	'disclaimer' => "Деякі анонімні дані можуть збиратися для статистичних цілей. Якщо було вказане OAuth-ім'я користувача, то воно також буде збережено для надання допомоги у випадку вандалізму. Паролі ніколи не зберігаються.", # Fuzzy
...
$messages['zh-hans'] = array(
	...
	'preview' => '预览',
	'translate' => '翻译',
	'translate-instructions' => '可以输入文件名（例如“$1”）或完整的URL（例如 "$2"）。如果选择第一个选项，维基共享资源会被作为来源。如果是从其他网站或wiki翻译SVG文件，您必须使用完整的URL。',
