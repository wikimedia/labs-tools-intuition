...
$messages['be-tarask'] = array(
	...
	'disclaimer' => 'Некаторыя ананімныя зьвесткі будуць зьбірацца неафіцыйна для статыстычных мэтаў. Калі будуць паданыя, імёны ўдзельнікаў TUSC будуць так сама запісаныя для дапамогі ў абароне супраць вандалізму. Паролі ніколі не будуць запісвацца.',
