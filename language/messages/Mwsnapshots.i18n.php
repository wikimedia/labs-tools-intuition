...
* $1 - repository name
See example: https://tools.wmflabs.org/snapshots/index.php#!/mediawiki-core/master',
...
$messages['af'] = array(
	'title-error' => 'Fout',
	'download-button' => 'Laai $1 af', # Fuzzy
	'download-directlink' => 'direkte skakel',
	'title-downloadpage' => 'Laai af: $1', # Fuzzy
...
$messages['as'] = array(
	...
	'download-button' => '$1 ডাউনল’ড', # Fuzzy
	'download-directlink' => 'পোণপটীয়া সংযোগ',
	'title-downloadpage' => 'ডাউনল’ড: $1', # Fuzzy
...
$messages['azb'] = array(
	...
	'download-button' => '$1-ی اندیر', # Fuzzy
	'download-directlink' => 'موستقیم باغلانتی',
	'title-downloadpage' => 'اندیر: $1', # Fuzzy
...
$messages['ba'] = array(
	...
	'download-button' => '$1 файлын тейәп аларғы', # Fuzzy
	'download-directlink' => 'туры һылтанма',
	'title-downloadpage' => 'Тейәп алырға: $1', # Fuzzy
...
$messages['bn'] = array(
	'title-overview' => 'ছবি',
	'title-error' => 'ত্রুটি',
	'title-updatelog' => 'হালনাগাদ লগ',
	'download-button' => 'স্ন্যাপশট ডাউনলোড করুন',
	'download-directlink' => 'সরাসরি লিংক',
	'title-downloadpage' => 'ডাউনলোড',
	'title-downloadpage-repo' => '$1 ডাউনলোড',
...
$messages['cs'] = array(
	...
	'download-button' => 'Stáhnout $1', # Fuzzy
	'download-directlink' => 'Přímý odkaz',
	'title-downloadpage' => 'Stažení: $1', # Fuzzy
...
$messages['cv'] = array(
	...
	'download-button' => '$1 тиесе ил', # Fuzzy
	'download-directlink' => 'тӳрӗ каҫӑ',
	'title-downloadpage' => 'Тиесе ил: $1', # Fuzzy
...
$messages['dsb'] = array(
	...
	'download-button' => '$1 ześěgnuś', # Fuzzy
	'download-directlink' => 'direktny wótkaz',
	'title-downloadpage' => 'Ześěgnjenje: $1', # Fuzzy
...
$messages['eo'] = array(
	...
	'download-button' => 'Elŝuti $1', # Fuzzy
	'download-directlink' => 'rekta ligilo',
	'title-downloadpage' => 'Elŝuti: $1', # Fuzzy
...
$messages['es'] = array(
	...
	'tablehead-hash' => 'Sumas de comprobación',
);
...
$messages['et'] = array(
	'title-error' => 'Viga',
	'download-button' => 'Laadi $1 alla', # Fuzzy
	'title-downloadpage' => 'Laadi alla: $1', # Fuzzy
...
$messages['fa'] = array(
	...
	'download-button' => 'دانلود عکس فوری',
	'download-directlink' => 'پیوند مستقیم',
	'title-downloadpage' => 'بارگیری',
	'title-downloadpage-repo' => 'بارگیری $1',
	'err-snapshotindex' => 'فهرست تصویرهای لحظه‌ای در دسترس نیست. لطفاً دوباره مراجعه کنید.',
	'err-invalid-repo' => 'مخزن ناشناخته «$1».',
	'err-invalid-branch' => 'شاخهٔ ناشناخته: «$1» در مخزن «$2».',
	'err-nosnapshot' => 'تصویرهای لحظه‌ای هر چند ساعت ایجاد می‌شوند. هنگام ایجاد $1، ایرادی وجود داشت. لطفاً بعداً، دوباره تلاش کنید.',
...
$messages['fi'] = array(
	...
	'download-button' => 'Lataa $1', # Fuzzy
	'download-directlink' => 'suora linkki',
	'title-downloadpage' => 'Lataa: $1', # Fuzzy
...
$messages['fo'] = array(
	...
	'download-button' => 'Tak niður $1', # Fuzzy
	'download-directlink' => 'beinleiðis leinkja',
	'title-downloadpage' => 'Tak niður: $1', # Fuzzy
...
$messages['frp'] = array(
	'title-error' => 'Fôta',
	'download-button' => 'Tèlèchargiér $1', # Fuzzy
	'download-directlink' => 'lim drêt',
	'title-downloadpage' => 'Tèlèchargiér : $1', # Fuzzy
...
$messages['gl'] = array(
	...
	'download-button' => 'Descargar "$1"', # Fuzzy
	'download-directlink' => 'ligazón directa',
	'title-downloadpage' => 'Descargar: $1', # Fuzzy
...
$messages['hi'] = array(
	...
	'download-button' => '$1 डाउनलोड करें', # Fuzzy
	'download-directlink' => 'सीधा लिंक',
	'title-downloadpage' => 'डाउनलोड: $1', # Fuzzy
...
$messages['hsb'] = array(
	...
	'download-button' => '$1 sćahnyć', # Fuzzy
	'download-directlink' => 'direktny wotkaz',
	'title-downloadpage' => 'Sćehnjenje: $1', # Fuzzy
...
$messages['ia'] = array(
	...
	'download-button' => 'Discargar $1', # Fuzzy
	'download-directlink' => 'ligamine directe',
	'title-downloadpage' => 'Discargar: $1', # Fuzzy
...
$messages['id'] = array(
	...
	'download-button' => 'Unduh $1', # Fuzzy
	'download-directlink' => 'tautan langsung',
	'title-downloadpage' => 'Unduh',
	'title-downloadpage-repo' => 'Unduh $1',
...
$messages['jv'] = array(
	...
	'download-button' => 'Undhuh $1', # Fuzzy
	'download-directlink' => 'pranala langsung',
	'title-downloadpage' => 'Undhuhan: $1', # Fuzzy
...
$messages['kn'] = array(
	...
	'download-button' => '$1 ನಕಲಿಳಿಸಿ', # Fuzzy
	'download-directlink' => 'ನೇರ ಕೊಂಡಿ',
	'title-downloadpage' => 'ನಕಲಿಳಿಸಿ: $1', # Fuzzy
...
Schpääder kanns De heh dann et kumplätte Protokoll dovun beloore.',
	'download-button' => '$1 eronger laade', # Fuzzy
	'download-directlink' => 'tiräkte Lenk',
	'title-downloadpage' => '$1 eronger laade', # Fuzzy
...
$messages['lrc'] = array(
	'title-error' => 'خطا',
	'download-button' => 'گرتن د عنوان $1', # Fuzzy
	'download-directlink' => 'هوم پیوند مستقیم',
	'title-downloadpage' => 'گرتن د عنوان $1', # Fuzzy
...
$messages['lt'] = array(
	...
	'download-button' => 'Atsisiųsti $1', # Fuzzy
	'download-directlink' => 'tiesioginė nuoroda',
	'title-downloadpage' => 'Atsisiųsti: $1', # Fuzzy
...
$messages['ml'] = array(
	...
	'title-error' => 'പിഴവ്',
	'download-button' => '$1 ആയി ഡൗൺലോഡ് ചെയ്യുക', # Fuzzy
	'download-directlink' => 'നേർ കണ്ണി',
	'title-downloadpage' => 'ഡൗൺലോഡ്: $1', # Fuzzy
...
$messages['ms'] = array(
	...
	'download-button' => 'Muat turun $1', # Fuzzy
	'download-directlink' => 'pautan terus',
	'title-downloadpage' => 'Muat turun: $1', # Fuzzy
...
$messages['mt'] = array(
	...
	'download-button' => 'Niżżel $1', # Fuzzy
	'download-directlink' => 'ħolqa diretta',
	'title-downloadpage' => 'Niżżel: $1', # Fuzzy
...
$messages['nb'] = array(
	...
	'download-button' => 'Last ned $1', # Fuzzy
	'download-directlink' => 'direktelenke',
	'title-downloadpage' => 'Last ned: $1', # Fuzzy
...
$messages['oc'] = array(
	...
	'download-button' => "Telecargar l'imatge instantanèu",
	'download-directlink' => 'ligam dirècte',
	'title-downloadpage' => 'Telecargar',
	'repo-site-link' => 'Site web',
	'repo-branches-label' => 'Brancas :',
	'repo-lastmoddate-label' => 'Data :',
...
$messages['or'] = array(
	...
	'download-button' => '$1 ଡାଉନଲୋଡ କରିବେ', # Fuzzy
	'download-directlink' => 'ସିଧା ଲିଙ୍କ',
	'title-downloadpage' => 'ଡାଉନଲୋଡ କରିବେ :$1', # Fuzzy
...
$messages['pms'] = array(
	...
	'download-button' => 'Dëscaria $1', # Fuzzy
	'download-directlink' => 'liura direta',
	'title-downloadpage' => 'Dëscaria: $1', # Fuzzy
...
$messages['ps'] = array(
	...
	'title-error' => 'تېروتنه',
	'download-button' => 'ښکته کول $1', # Fuzzy
	'download-directlink' => 'نېغه تړنه',
	'title-downloadpage' => 'ښکته کول: $1', # Fuzzy
...
$messages['pt-br'] = array(
	...
	'download-button' => 'Baixar $1', # Fuzzy
	'download-directlink' => 'link direto',
	'title-downloadpage' => 'Baixar: $1', # Fuzzy
...
$messages['si'] = array(
	...
	'download-button' => '$1 බාගන්න', # Fuzzy
	'download-directlink' => 'සෘජු සබැඳිය',
	'title-downloadpage' => 'බාගන්න: $1', # Fuzzy
...
$messages['so'] = array(
	...
	'download-button' => 'Soo daji $1', # Fuzzy
	'download-directlink' => 'Link toos ah',
	'title-downloadpage' => 'Soo daji $1', # Fuzzy
...
$messages['sq'] = array(
	...
	'download-button' => 'Shkarko $1', # Fuzzy
	'download-directlink' => 'Lidhja e drejtpërdrejtë',
	'title-downloadpage' => 'Shkarko: $1', # Fuzzy
...
$messages['sr-ec'] = array(
	...
	'updatelog-intro' => 'Скрипт врши ажурирања сваког сата. Испод је приказан извод конзоле од последњег ажурирања.',
	'updatelog-active' => 'Скрипт тренутно врши ажурирања. Вратите се касније за целокупан дневник.',
	'download-button' => 'Преузми снимак',
	'download-directlink' => 'директна веза',
	'title-downloadpage' => 'Преузми',
	'title-downloadpage-repo' => 'Преузми $1',
	'err-snapshotindex' => 'Индекс снимака је привремено недоступан. Покушајте касније.',
	'err-invalid-repo' => 'Непозната ризница: „$1“.',
	'err-invalid-branch' => 'Непозната грана: „$1“ у ризници „$2“.',
	'err-nosnapshot' => 'Снимци се генеришу сваких неколико сати. Дошло је до грешке при генерисању снимка „$1“. Покушајте касније.',
	'err-noupdatelog' => 'Дневник ажурирања није пронађен.',
	'repo-site-link' => 'Сајт',
...
$messages['sr-el'] = array(
	...
	'download-button' => 'Preuzmi $1', # Fuzzy
	'download-directlink' => 'direktna veza',
	'title-downloadpage' => 'Preuzimanje: $1', # Fuzzy
...
$messages['ta'] = array(
	...
	'download-button' => '$1 ஐத் தரவிறக்கு', # Fuzzy
	'download-directlink' => 'நேரடி இணைப்பு',
	'title-downloadpage' => 'தரவிறக்கவும்',
	'title-downloadpage-repo' => '$1 தகவலிறக்கு',
...
$messages['tl'] = array(
	...
	'download-button' => 'Ikargang paibaba ang $1', # Fuzzy
	'download-directlink' => 'tuwirang kawing',
	'title-downloadpage' => 'Ikargang paibaba: $1', # Fuzzy
...
$messages['ug-arab'] = array(
	...
	'download-button' => '$1 چۈشۈر', # Fuzzy
	'download-directlink' => 'بىۋاستە ئۇلانما',
	'title-downloadpage' => 'چۈشۈر: $1', # Fuzzy
...
$messages['uk'] = array(
	...
	'download-button' => 'Завантажити знімок',
	'download-directlink' => 'прямі посилання',
	'title-downloadpage' => 'Завантажити',
	'title-downloadpage-repo' => 'Завантажити $1',
...
$messages['zh-hant'] = array(
	...
	'download-button' => '下載$1', # Fuzzy
	'download-directlink' => '直接連結',
	'title-downloadpage' => '下載',
	'title-downloadpage-repo' => '下載：$1',
